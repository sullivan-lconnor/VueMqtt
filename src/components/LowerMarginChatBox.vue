<template>
    <div class="box" :style="{width: marginWidth, height: marginHeight}">
        <span>
             <MqttChatLog topic_:{topic}/>
        </span>
    </div>
</template>
...
export default {
    ...
    created() {
        if (this.width) { this.marginWidth = this.width; }
        if (this.height) { this.marginHeight = this.height; }
    }
}
</script>
